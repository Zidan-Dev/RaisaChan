...
exports.makeWASocket = (connectionOptions, options = {}) => {
  ...
  /**
    ...
    */
    ...
    conn.sendStickerAll = async (jid, path, quoted, options = {}) => {
...
`.trim()
    ...
    */
    conn.sendGroupV4Invite = async (jid, participant, inviteCode, inviteExpiration, groupName = 'unknown subject', caption = 'Invitation to join my WhatsApp group', jpegThumbnail, options = {}) => {
    	let image = await prepareWAMessageMedia({ image: jpegThumbnail }, { upload: conn.waUploadToServer })
    	let msg = await generateWAMessageFromContent(participant, proto.Message.fromObject({
    		groupInviteMessage: {
    			groupJid: jid,
    			inviteCode,
